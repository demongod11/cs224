...
#endif
static const char *ng0 = "din=%d reset=%b load=%b sh=%b lin=%b ans=%d";
static const char *ng1 = "C:/cs221_lab/cs224_quiz2/quiz2A_test.v";
static int ng2[] = {0, 0};
static int ng3[] = {1, 0};
static int ng4[] = {4, 0};
static int ng5[] = {6, 0};
...
LAB0:    t1 = (t0 + 1448);
    ...
    t16 = (t0 + 1048U);
    t17 = *((char **)t16);
    xsi_vlogfile_write(1, 0, 3, ng0, 7, t0, (char)118, t3, 4, (char)118, t6, 1, (char)118, t9, 1, (char)118, t12, 1, (char)118, t15, 1, (char)118, t17, 4);
...
LAB11:    xsi_set_current_line(65, ng1);
    t3 = ((char*)((ng3)));
    t4 = (t0 + 2248);
    xsi_vlogvar_assign_value(t4, t3, 0, 0, 1);
    xsi_set_current_line(65, ng1);
...
LAB14:    xsi_set_current_line(68, ng1);
    xsi_vlog_stop(1);
    goto LAB1;
...
extern void work_m_00000000000312857323_2034068148_init()
{
	static char *pe[] = {(void *)Initial_49_0,(void *)Monitor_57_1};
	xsi_register_didat("work_m_00000000000312857323_2034068148", "isim/quiz2A_test_isim_beh.exe.sim/work/m_00000000000312857323_2034068148.didat");
