...
#endif
static const char *ng0 = "/home/chandrabhushan/coding/cs224_labs/lab_10/sram_sync.v";
static int ng1[] = {0, 0};
static int ng2[] = {6, 0};
static int ng3[] = {1, 0};
...
static int ng8[] = {8, 0};
static unsigned int ng9[] = {35141U, 0U};
static int ng10[] = {9, 0};
...
{
	static char *pe[] = {(void *)Initial_30_0,(void *)Always_45_1};
